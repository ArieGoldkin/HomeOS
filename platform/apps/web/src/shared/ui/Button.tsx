...
/**
 * Primary action button for the HomeOS phone surface. Three visual variants
 * cover every surface need: ocean-filled CTA, quiet ghost, and a dashed
 * "add" affordance. Uses `type="button"` by default to avoid accidental form
 * submission when nested inside a `<form>`.
 */
const button = cva(
